...
import { listQuestionsFromQuiz, removeQuestionFromQuiz } from '../../firebase/quiz/quiz'
        ...
        <div className="registeredQuestions">
          ...
          {perguntas.length > 0 ? (
            perguntas.map((pergunta, index) => {
              ...
              const correta = cleanText(pergunta.correta || (pergunta as any)['correta: '] || 'Sem resposta')
